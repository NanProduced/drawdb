...
const zh = {
  translation: {
    ...
    ai_assistant: "AI 助手",
    ai_thinking: "思考中...",
    ai_designer_title: "AI 数据库设计师",
    ai_designer_desc: "描述你的数据库需求，我会为你设计并创建表结构。",
    ai_configure_key: "配置 API Key",
    ai_configure_key_start: "配置 API Key 后开始使用",
    ai_clear_chat: "清空对话",
    ai_minimize: "最小化",
    ai_placeholder: "描述你的数据库需求...",
    ai_send: "发送",
    ai_stop: "停止",
    ai_tables_created: "已创建 {{count}} 个表",
    ai_tool_executed: "工具已执行",
    ai_saved: "AI 设置已保存",
    ai_provider: "AI 服务商",
    ai_api_key: "API Key",
    ai_api_key_placeholder: "输入你的 API Key",
    ai_api_key_hint: "密钥存储在浏览器本地，不会发送到我们的服务器。",
    ai_model: "模型",
    ai_base_url: "自定义 Base URL",
    ai_base_url_optional: "（可选）",
    ai_base_url_hint: "留空使用默认地址。可设置自定义 URL 用于代理或兼容接口。",
    ai_test_connection: "测试连接",
    ai_connection_success_openai: "OpenAI 连接成功！",
    ai_connection_success_claude: "Claude 连接成功！",
    ai_connection_failed: "连接失败：{{message}}",
    ai_no_api_key: "请先输入 API Key",
    ai_operation_cancelled: "操作已取消。",
    ai_error_prefix: "错误：",
    ai_please_configure_api_key: "请先在 AI 设置中配置 API Key。",
    ...
    see_all: "查看全部",
    snap_to_grid: "对齐网格线",
    import_from_postgres: "连接 PostgreSQL",
    postgres_host: "主机",
    postgres_port: "端口",
    ...
    postgres_fetch_schema: "获取结构",
    postgres_fetching_schema: "正在获取结构...",
    postgres_test_connection: "测试连接",
    postgres_testing: "测试中...",
    postgres_connection_success: "连接成功！",
    postgres_tables_fetched: "成功获取 {{count}} 个表。准备导入。",
    postgres_fetch_failed: "获取结构失败",
    postgres_please_fill_fields: "请填写所有必填字段（主机、端口、数据库、用户名）",
    postgres_tables: "表",
    postgres_columns: "列",
    postgres_foreign_keys: "外键",
    postgres_raw_json: "原始 JSON",
    postgres_table_type_table: "表",
    postgres_table_type_view: "视图",
    postgres_yes: "✓",
    postgres_no: "",
    postgres_na: "-",
    postgres_conflict_title: "导入冲突",
    postgres_conflict_message: "以下 {{count}} 个表已存在于您的图表中。您希望如何处理？",
    postgres_conflict_table_list: "冲突的表：{{tables}}",
    postgres_option_overwrite: "覆盖",
    postgres_option_overwrite_desc: "用导入的表替换现有表",
    postgres_option_append: "追加",
    postgres_option_append_desc: "用新ID添加导入的表（现有表保留）",
    postgres_option_cancel: "取消",
    postgres_option_cancel_desc: "不导入任何内容",
  },
};
