...
const en = {
  translation: {
    ...
    database: "Database",
    saved: "Saved",
    ai_generate_schema: "Generate database schema with AI",
    ai_need_api_key: "Configure API Key first",
    ai_generate_database: "AI Database Generator",
    ai_settings_title: "AI Settings",
    ai_api_key_label: "API Key",
    ai_base_url_label: "Base URL",
    ai_base_url_hint: "OpenAI compatible API endpoint (e.g., https://api.openai.com/v1)",
    ai_prompt_label: "Describe your database",
    ai_prompt_placeholder: "e.g., Create an e-commerce system with users, products, orders, and shopping carts",
    ai_example_prompts: "Try these examples",
    ai_mode_append: "Append to current diagram",
    ai_mode_replace: "Clear and replace",
    ai_prompt_required: "Please describe your database requirements.",
    ai_api_key_required: "Please configure your API Key first.",
    ai_no_tables_generated: "No tables were generated. Please try a different description.",
    ai_generation_error: "Failed to generate schema. Please check your API Key and try again.",
