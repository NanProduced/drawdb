...
const en = {
  translation: {
    ...
    ai_designer_title: "AI Database Designer",
    ai_designer_desc: "Describe your database requirements and I'll design and create the tables for you.",
    ai_configure_key: "Configure API Key",
    ai_configure_key_start: "Configure API Key to start",
    ai_clear_chat: "Clear chat",
    ai_minimize: "Minimize",
    ai_placeholder: "Describe your database requirements...",
    ai_send: "Send",
    ai_stop: "Stop",
    ai_tables_created: "{{count}} table(s) created",
    ai_tool_executed: "Tool executed",
    ai_saved: "AI settings saved",
    ai_provider: "AI Provider",
    ai_api_key: "API Key",
    ai_api_key_placeholder: "Enter your API Key",
    ai_api_key_hint: "Stored locally in your browser. Never sent to our servers.",
    ai_model: "Model",
    ai_base_url: "Custom Base URL",
    ai_base_url_optional: "(optional)",
    ai_base_url_hint: "Leave empty for default. Set a custom URL for proxies or compatible APIs.",
    ai_test_connection: "Test Connection",
    ai_connection_success_openai: "OpenAI connection successful!",
    ai_connection_success_claude: "Claude connection successful!",
    ai_connection_failed: "Connection failed: {{message}}",
    ai_no_api_key: "Please enter an API Key first",
    ai_operation_cancelled: "Operation cancelled.",
    ai_error_prefix: "Error: ",
    ai_please_configure_api_key: "Please configure your API Key in AI Settings first.",
    type_color: "Color",
    ...
    database: "Database",
    saved: "Saved",
    import_from_postgres: "Connect to PostgreSQL",
    postgres_host: "Host",
    postgres_port: "Port",
    ...
    postgres_fetch_schema: "Fetch Schema",
    postgres_fetching_schema: "Fetching Schema...",
    postgres_test_connection: "Test Connection",
    postgres_testing: "Testing...",
    postgres_connection_success: "Connection successful!",
    postgres_tables_fetched: "Successfully fetched {{count}} table(s). Ready to import.",
    postgres_fetch_failed: "Failed to fetch schema",
    postgres_please_fill_fields: "Please fill in all required fields (Host, Port, Database, User)",
    postgres_tables: "Tables",
    postgres_columns: "Columns",
    postgres_foreign_keys: "Foreign Keys",
    postgres_raw_json: "Raw JSON",
    postgres_table_type_table: "Table",
    postgres_table_type_view: "View",
    postgres_yes: "✓",
    postgres_no: "",
    postgres_na: "-",
    postgres_conflict_title: "Import Conflict",
    postgres_conflict_message: "The following {{count}} table(s) already exist in your diagram. What would you like to do?",
    postgres_conflict_table_list: "Conflicting tables: {{tables}}",
    postgres_option_overwrite: "Overwrite",
    postgres_option_overwrite_desc: "Replace existing tables with imported ones",
    postgres_option_append: "Append",
    postgres_option_append_desc: "Add imported tables with new IDs (existing tables remain)",
    postgres_option_cancel: "Cancel",
    postgres_option_cancel_desc: "Do not import anything",
  },
};
